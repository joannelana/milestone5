...
if (isset($_POST['DriverEventID'])) 
{
	...
	$sql = "DELETE from PendingRides WHERE DriverEventID='$DriverEventID'";
	...
	$conn = connDB();
	$sql = "DELETE from ConfirmedRides WHERE DriverEventID='$DriverEventID'";
	...
	$conn = connDB();
	$sql = "UPDATE RiderRequest SET Fulfilled=0 WHERE DriverEventID='$DriverEventID'";
	...
	$sql = "DELETE from PendingRides WHERE RiderEventID='$RiderEventID'";
	...
	$conn = connDB();
	$sql = "DELETE from ConfirmedRides WHERE RiderEventID='$RiderEventID'";

...
{
  echo '<span style="color: red;">Password changed failed</span><br/>';
}
...
{
  echo '<span style="color: green;">Account deleted successfully. </span><br/>';
}
if (isset($_GET['success']) && $_GET['success'] == 4)
{
  echo '<span style="color: red;">Account deletion failed</span><br/>';
}
?>
	</div>
</div>